...
module.exports = {
	...
	getConsultaot :  function (req, res, next){
		...
		dbo.GLO_FU_FormatoFechaHora(dbo.UTI_Otrabajo.FechaOT) AS FechaOT, 
         ...
         dbo.UTI_Otrabajo.IdUnidad, dbo.UTI_Unidad.NombreUnidad, dbo.UTI_Otrabajo.CodigoActivoFijo, dbo.UTI_FIJ_ActivosFijos.NombreActivoFijo + ' ' + dbo.UTI_Otrabajo.CodigoActivoFijo AS NombreActivoFijo, 
	     ...
	     dbo.UTI_Estados ON dbo.UTI_Otrabajo.IdEstado = dbo.UTI_Estados.IdEstado`;
